...
class StartUITest {
    ...
    void whenReplaceItem() {
        ...
        Input input = new MockInput(
                ...
                /* входные параметры для ReplaceAction (должны содержать ID добавленной заявки item.getId()) */
        );
        UserAction[] actions = {
    ...
    void whenDeleteItem() {
        ...
        ); /* входные параметры для DeleteAction (должны содержать ID добавленной заявки item.getId()) */
        UserAction[] actions = {
